            ...
            <div class="container">
                <div class="row">
	                ...
	                <div class="col-md-6 ml-auto mr-auto">
        	           <div class="profile">
	                        <div class="avatar">
	                            <img src="public/images/user.jpg" alt="Circle Image" class="img-raised rounded-circle img-fluid">
	                        </div>                       
	                        <div class="name">       
                            <br>                 
	                            <h3 ><?php echo $item['name']; ?></h3> 
                               <h6><?php echo"Số điện thoại: 0".$item['phone'];?></h6>                              						
	                        </div>
