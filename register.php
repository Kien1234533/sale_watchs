...
if (isset($_POST['username'])) {
    ...
    if ($userModel->addUser($username,$password,$name,$phone)) {
    ...
    <div class="main-agileinfo">
      <div class="agileits-top">
        <form action="#" method="post">
          <input class="text" type="text" name="name" id ="name" placeholder="Fullname" required="">
          <input  class="text"type="text" name="phone" id ="phone" placeholder="Phone number" required="">
